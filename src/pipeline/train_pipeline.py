...
from src.components.data_ingesation import DataIngestion
        ...
        def start_data_transformation(self,feature_store_file_path):
            ...
            def start_model_training(self, train_arr,test_arr):
                ...
                def run_pipeline(self):
                    try:
                        feature-store_file_path = self.start_data_ingestion()
                        train_arr,test_arr,preprocessor-path = self.start_data-transformation(feature_store_file_path)
