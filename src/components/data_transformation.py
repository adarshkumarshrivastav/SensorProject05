        ...
        def get_data(feature_store_file_path:str)->pd.DataFrame:
            ...
            def get_data_transformer_objects(self):
                ...
                def initiate_data_transformation(self):
                    ...
                    logging.info("Entered initiate data transfomation method of data transformation class")
                    ...
                    try:
                        ...
                        train_arr = np.c[X_train_sacled,np.array(y_train)]
                        test_arr = np.c[X_test_scaled,np.array(y_test)]

                        return (train_arr,test_arr,preprocessing_path)
                    except Exception as e:
